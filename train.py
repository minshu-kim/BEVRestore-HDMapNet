...
def train(args):
    ...
    #            param.requires_grad = False
            #if 'bevencode.seg_sr' in name or 'bevencode.seg_decoder' in name:
            #    param.requires_grad = True
            #elif 'bevencode.embed_sr' in name or 'bevencode.embed_decoder' in name:
            #    param.requires_grad = True
            #elif 'bevencode.direction_sr' in name or 'bevencode.direction_decoder' in name:
            #    param.requires_grad = True
            #elif 'bevencode.up' in name or 'bevencode.layer3' in name:
            #    param.requires_grad = True
            #elif 'bevencode.layer1' in name or 'bevencode.layer2' in name:
            #    param.requires_grad = True
            #else:
            #    param.requires_grad = False
